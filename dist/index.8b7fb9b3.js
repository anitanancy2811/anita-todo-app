...
const onAppInit = async function(e) {
    const employees = await _dataFetcher.dataFetcher('data/todos.json');
    _store.createStore(_keys.keyGenerator(employees));
    _router.Router(window.location.pathname);
};
window.addEventListener('load', onAppInit);

},{"./routes/router":"f0QlQ","./redux/store":"2rtCO","./utils/dataFetcher":"8J3wM","./utils/keys":"1IUcQ"}],"f0QlQ":[function(require,module,exports) {
...
const routes = {
    ...
    "/directory": _toDoPageDefault.default,
    "/notFound": _notFoundDefault.default
};
...
},{"../pages/index":"4ZMnd","../pages/toDoPage":"B5bua","../pages/notFound":"3FOuT","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"4ZMnd":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const index = function() {
    ...
    const todoListLink = _linkDefault.default("Enter to Todo App", '/directory');
    const template = `
    ...
    `;
    const pageHeader = _makeElementDefault.default(template);
...
},{"./../utils/makeElement":"8ZxEo","./../components/ui/link":"hFEwy","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"8ZxEo":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _home = require("../components/cards/home");
...
const directoryPage = function() {
    const page = document.createElement('div');
    const container = _homeDefault.default();
    const employeeList = _store.getStore();
    if (employeeList.length !== 0) {
        const elements = employeeList.map((emp)=>{
            return _todoItemDefault.default(emp);
        });
...
},{"../redux/store":"2rtCO","../components/cards/todoItem":"5X1eL","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV","../components/cards/home":"ibODz"}],"2rtCO":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"5X1eL":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _makeElement = require("../../utils/makeElement");
var _makeElementDefault = parcelHelpers.interopDefault(_makeElement);
...
},{"../../utils/makeElement":"8ZxEo","../ui/link":"hFEwy","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"ibODz":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _makeElement = require("./../../utils/makeElement");
var _makeElementDefault = parcelHelpers.interopDefault(_makeElement);
...
},{"./../../utils/makeElement":"8ZxEo","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"3FOuT":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _makeElement = require("./../utils/makeElement");
var _makeElementDefault = parcelHelpers.interopDefault(_makeElement);
...
const notFound = function() {
    const page = document.createElement('div');
    const backToSafety = _linkDefault.default("Back to to-dos", '/directory');
    const template = `
        <header class="ui-header">
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"1IUcQ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./validate.js":"gyXYN","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}]},["cSv3F","3auaO"], "3auaO", "parcelRequire683a")
